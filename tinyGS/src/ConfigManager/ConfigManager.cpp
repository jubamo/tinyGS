...
ConfigManager::ConfigManager()
    : IotWebConf2(thingName, &dnsServer, &server, initialApPassword, configVersion), server(80), gsConfigHtmlFormatProvider(*this), boards({
                                                                                                                                        //OLED_add, OLED_SDA,  OLED_SCL, OLED_RST, PROG_BUTTON, BOARD_LED, L_SX127X?, L_NSS, L_DI00, L_DI01, L_BUSSY, L_RST,  L_MISO, L_MOSI, L_SCK, L_TCXO_V, RXEN, TXEN, BOARD
                                                                                                                                        {0x3c, 4, 15, 16, 0, 25, 1, 18, 26, 12, 0, 14, 19, 27, 5, 0.0f, UNUSED, UNUSED, "433Mhz HELTEC WiFi LoRA 32 V1"}, // @4m1g0
                                                                                                                                        {0x3c, 4, 15, 16, 0, 25, 1, 18, 26, 12, 0, 14, 19, 27, 5, 0.0f, UNUSED, UNUSED, "863-928Mhz HELTEC WiFi LoRA 32 V1"},
                                                                                                                                        {0x3c, 4, 15, 16, 0, 25, 1, 18, 26, 35, 0, 14, 19, 27, 5, 0.0f, UNUSED, UNUSED, "433Mhz HELTEC WiFi LoRA 32 V2"}, // @4m1g0
                                                                                                                                        {0x3c, 4, 15, 16, 0, 25, 1, 18, 26, 35, 0, 14, 19, 27, 5, 0.0f, UNUSED, UNUSED, "863-928Mhz HELTEC WiFi LoRA 32 V2"},
                                                                                                                                        {0x3c, 4, 15, 16, 0, 2, 1, 18, 26, 0, 0, 14, 19, 27, 5, 0.0f, UNUSED, UNUSED, "433Mhz  TTGO LoRa 32 v1"},       // @g4lile0
                                                                                                                                        {0x3c, 4, 15, 16, 0, 2, 1, 18, 26, 0, 0, 14, 19, 27, 5, 0.0f, UNUSED, UNUSED, "868-915Mhz TTGO LoRa 32 v1"},    //
                                                                                                                                        {0x3c, 21, 22, 16, 0, 22, 1, 18, 26, 33, 0, 14, 19, 27, 5, 0.0f, UNUSED, UNUSED, "433 Mhz TTGO LoRA 32 v2"},    // @TCRobotics
                                                                                                                                        {0x3c, 21, 22, 16, 0, 22, 1, 18, 26, 33, 0, 14, 19, 27, 5, 0.0f, UNUSED, UNUSED, "868-915Mhz TTGO LoRA 32 v2"}, //
                                                                                                                                        {0x3c, 21, 22, 16, 39, 22, 1, 18, 26, 33, 32, 14, 19, 27, 5, 0.0f, UNUSED, UNUSED, "433Mhz T-BEAM + OLED"},
                                                                                                                                        {0x3c, 21, 22, 16, 39, 22, 1, 18, 26, 33, 32, 14, 19, 27, 5, 0.0f, UNUSED, UNUSED, "868-915Mhz T-BEAM + OLED"},
                                                                                                                                        {0x3c, 21, 22, 16, 0, 25, 0, 5, 0, 27, 26, 14, 19, 23, 18, 0.0f, UNUSED, UNUSED, "Custom ESP32 Wroom + SX126x (Crystal)"},                       // @4m1g0, @lillefyr
                                                                                                                                        {0x3c, 21, 22, 16, 0, 25, 0, 18, 0, 33, 32, 14, 19, 27, 5, 0.0f, UNUSED, UNUSED, "TTGO LoRa 32 V2 Modified with module SX126x (crystal)"},       // @TCRobotics
                                                                                                                                        {0x3c, 21, 22, 16, 0, 25, 0, 5, 0, 2, 13, 26, 19, 23, 18, 1.6f, UNUSED, UNUSED, "Custom ESP32 Wroom + SX126x DRF1268T (TCX0) (5, 2, 26, 13)"},   // @sdey76
                                                                                                                                        {0x3c, 21, 22, 16, 0, 25, 0, 5, 0, 26, 12, 14, 19, 23, 18, 1.6f, UNUSED, UNUSED, "Custom ESP32 Wroom + SX126x DRF1268T (TCX0) (5, 26, 14, 12)"}, // @imants
                                                                                                                                        {0x3c, 21, 22, 16, 38, 22, 1, 18, 26, 33, 0, 14, 19, 27, 5, 0.0f, UNUSED, UNUSED, "T-BEAM V1.0 + OLED"},                                         // @fafu
                                                                                                                                        {0x3c, 21, 22, 16, 0, 2, 0, 5, 0, 34, 32, 14, 19, 27, 18, 1.6f, UNUSED, UNUSED, "433Mhz FOSSA 1W Ground Station"},                               // @jgromes
                                                                                                                                        {0x3c, 21, 22, 16, 0, 2, 0, 5, 0, 34, 32, 14, 19, 27, 18, 1.6f, UNUSED, UNUSED, "868-915Mhz FOSSA 1W Ground Station"},                           // @jgromes
                                                                                                                                    })
{
