...
ConfigManager::ConfigManager()
  ...
  {      0x3c,       17,        18,       21,           0,        35,      6,     8,   UNUSED,   14,     13,    12,      11,     10,     9,     1.6f,   "150–960Mhz HELTEC LORA32 V3 SX1262"    },  // SX1262
  {      0x3c,       17,        18,     UNUSED,         0,        35,      1,     8,      6,     14,   UNUSED,  12,      11,     10,     9,     0.0f,   "Custom ESP32-S3 433MHz SX1278"     },  // SX1278 @g4lile0
#elif CONFIG_IDF_TARGET_ESP32C3
  {      0x3c,        0,        1,      UNUSED,        20,        21,      6,    8,    UNUSED,    3,      4,     5,       6,      7,    10,     1.6f,   "433MHz HELTEC LORA32 HT-CT62 SX1262" },  // SX1262  @gargomoma
  {      0x3c,        0,        1,      UNUSED,        20,        21,      1,    8,     4,     UNUSED, UNUSED,   5,       6,      7,    10,     0.0f,   "Custom ESP32-C3 433MHz SX1278"     },  // SX1278 @gargomoma
#else
  ...
  {      0x3c,        4,        15,       16,           0,         2,      1,    18,     26,   UNUSED, UNUSED , 23,      19,     27,     5,     0.0f,   "433Mhz  TTGO LoRa 32 v1"        },     // SX1278 @g4lile0 
  {      0x3c,        4,        15,       16,           0,         2,      2,    18,     26,   UNUSED, UNUSED , 23,      19,     27,     5,     0.0f,   "868-915MHz TTGO LoRa 32 v1"        },  // SX1276
  {      0x3c,       21,        22,     UNUSED,         0,        22,      1,    18,     26,     33,   UNUSED , 23,      19,     27,     5,     0.0f,   "433MHz TTGO LoRA 32 v2"        },      // SX1278  @TCRobotics
  {      0x3c,       21,        22,       16,           0,        22,      2,    18,     26,     33,   UNUSED , 23,      19,     27,     5,     0.0f,   "868-915MHz TTGO LoRA 32 v2"        },  // SX1276
  {      0x3c,       21,        22,       16,         39,        22,      1,    18,     26,     33,     32,    14,      19,     27,     5,     0.0f,   "433MHz T-BEAM + OLED"        },        // SX1278
  {      0x3c,       21,        22,     UNUSED,        39,        22,      2,    18,     26,     33,     32,    14,      19,     27,     5,     0.0f,   "868-915MHz T-BEAM + OLED"        },    // SX1276
  {      0x3c,       21,        22,       16,           0,        25,      5,     5,   UNUSED,   27,     26,    14,      19,     23,    18,     0.0f,   "Custom ESP32 Wroom + SX126x (Crystal)"  }, // SX1268 @4m1g0, @lillefyr
  {      0x3c,       21,        22,     UNUSED,         0,        25,      5,    18,   UNUSED,   33,     32,    14,      19,     27,     5,     0.0f,   "TTGO LoRa 32 V2 Modified with module SX126x (crystal)"  }, // SX1268 @TCRobotics
  ...
  {      0x3c,       21,        22,     UNUSED,         0,         2,      5,     5,   UNUSED,   34,     32,    14,      19,     27,    18,     1.6f,   "433MHz FOSSA 1W Ground Station"  },     // SX1268 @jgromes
  {      0x3c,       21,        22,       16,           0,         2,      2,     5,   UNUSED,   34,     32,    14,      19,     27,    18,     1.6f,   "868-915MHz FOSSA 1W Ground Station"  }, //SX1276 @jgromes
  {      0x3c,       21,        22,     UNUSED,         0,        22,      8,     5,     26,     34,     32,    14,      19,     27,    18,     0.0f,   "2.4GHz ESP32 + SX1280"  },              //SX1280 @g4lile0
  {      0x3c,       21,        22,     UNUSED,        38,        22,      2,    18,     26,     33,   UNUSED , 14,      19,     27,     5,     0.0f,   "868-915MHz T-BEAM V1.0 + OLED"   },     // SX1276 @fafu
  {      0x3c,       21,        22,     UNUSED,         0,        25,      1,    18,     26,     33,   UNUSED , 23,      19,     27,     5,     0.0f,   "433MHz LILYGO T3_V1.6.1"     },         // SX1278
  {      0x3c,       21,        22,     UNUSED,         0,        25,      2,    18,     26,     33,   UNUSED , 23,      19,     27,     5,     0.0f,   "868-915MHz LILYGO T3_V1.6.1"     },     // SX1276
